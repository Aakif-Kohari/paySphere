...
const categoryLimitSchema = new mongoose.Schema({
    category: {
        type: String,
        required: true,
        enum: ['Travel', 'Meals', 'Lodging', 'Office Supplies', 'Software', 'Client Entertainment', 'Other']
    },
...
const expenseClaimSchema = new mongoose.Schema({
    ...
    status: {
        type: String,
        enum: ['Draft', 'Submitted', 'Auto-Approved', 'Pending Manager', 'Approved', 'Rejected', 'Paid'],
        default: 'Draft',
        index: true
    },
