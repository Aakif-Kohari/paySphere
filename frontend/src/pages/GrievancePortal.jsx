...
// `@mui/icons-material/CheckCircleOutline` does not exist in the installed v9
// — only the Outlined/Rounded/Sharp/TwoTone variants of that name ship — so
// this line stopped the production build dead:
//
//     [vite]: Rollup failed to resolve import
//     "@mui/icons-material/CheckCircleOutline" from GrievancePortal.jsx
//
// It survived because this page has never had a route (#1012): nothing
// imported it, so no bundler ever tried to resolve the line.
// `CheckCircleOutlined` is the same glyph under a name the package ships.
...
export default function GrievancePortal() {
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-slate-950 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 text-center border border-gray-200 dark:border-slate-700">
          ...
          <h2 className="mt-4 text-2xl font-bold text-gray-900 dark:text-white">
            Grievance Filed Securely
          </h2>
          <p className="mt-2 text-sm text-gray-600 dark:text-slate-400">
            Your complaint has been encrypted and routed to the Internal
            Complaints Committee (ICC). Please save your case number for future
            reference.
          </p>
          <div className="mt-6 p-4 bg-gray-100 dark:bg-slate-900 rounded-lg border border-gray-200 dark:border-slate-700">
            ...
            <p className="text-2xl font-mono font-bold text-brand-600 dark:text-brand-400">
              {caseNumber}
            </p>
          </div>
        </div>
  ...
  return (
    <>
      <Helmet>
        <title>Secure Grievance Portal | PaySphere</title>
      </Helmet>
      <div className="min-h-screen bg-gray-50 dark:bg-slate-950 flex items-center justify-center p-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-brand-100">
                  Secure & Confidential Grievance Redressal
                </p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg flex items-start gap-3">
              ...
              <p className="text-xs text-blue-800 dark:text-blue-300">
                <strong>End-to-End Encrypted:</strong> Your submission is
                encrypted at rest. Standard HR and Admin roles cannot access
                this data. Only verified ICC members can decrypt and review case
                details.
              </p>
            </div>
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-slate-900/50 rounded-lg border border-gray-200 dark:border-slate-700">
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-slate-400">
                  Your identity will not be linked to this case.
                </p>
              </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-brand-500"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows="6"
                  placeholder="Please describe the incident in detail. This text will be encrypted."
                  className="w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-brand-500"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full py-3 bg-brand-600 hover:bg-brand-700 text-white font-bold rounded-lg shadow-md transition-colors disabled:opacity-50"
            >
